...
void Temperate_Handler(char *pcInsert)
{
	...
	//获取内部温度值
	Temperate = 12000; //获取温度值 此处扩大了100倍
...
void RTCTime_Handler(char *pcInsert)
{
 ...
 //   sec=RTC_TimeStruct.Seconds;
	...
	*pcInsert     = (char)((15/10) + 0x30);
	*(pcInsert+1) = (char)((15%10) + 0x30);
	*(pcInsert+2) = ':';
	*(pcInsert+3) = (char)((30/10) + 0x30);
	*(pcInsert+4) = (char)((30%10) + 0x30);
	*(pcInsert+5) = ':';
	*(pcInsert+6) = (char)((15/10) + 0x30);
	*(pcInsert+7) = (char)((15%10) + 0x30);
}
...
void RTCdate_Handler(char *pcInsert)
{
	...
	*pcInsert = '2';
	*(pcInsert+1) = '0';
	*(pcInsert+2) = (char)((2019/10) + 0x30);
	*(pcInsert+3) = (char)((2019 %10) + 0x30);
	*(pcInsert+4) = '-';
	*(pcInsert+5) = (char)((12/10) + 0x30);
	*(pcInsert+6) = (char)((12%10) + 0x30);
	*(pcInsert+7) = '-';
	*(pcInsert+8) = (char)((25/10) + 0x30);
	*(pcInsert+9) = (char)((25%10) + 0x30);
	*(pcInsert+10) = ' ';
	*(pcInsert+11) = 'w';
	*(pcInsert+12) = 'e';
	*(pcInsert+13) = 'e';
